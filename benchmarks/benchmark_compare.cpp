...
//
// Build with:  cmake -DDDX_BUILD_COMPARE=ON -DDDX_BUILD_BENCHMARKS=OFF ..
...
static void BM_Ours_Forward_Hess(benchmark::State &state) {
  ...
  for (auto _ : state) {
    benchmark::DoNotOptimize(xs);
    auto H = ddx::impl::detail::hessian(f, xs);
    benchmark::DoNotOptimize(H);
    benchmark::ClobberMemory();
  }
}
...
template <typename Vec>
DDX_ALWAYS_INLINE static auto vf_energy_sparse(const Vec &y, std::size_t n) {
...
// so nothing else here exercises what ddx::impl::hessian() picks for a raw callable.
...
static auto make_chain_expr4() {
  ...
  ddx::impl::Variable<D, FixedString{"x00"}> a;
  ddx::impl::Variable<D, FixedString{"x01"}> b;
  ddx::impl::Variable<D, FixedString{"x02"}> c;
  ddx::impl::Variable<D, FixedString{"x03"}> d;
...
static auto make_chain_expr8() {
  ...
  ddx::impl::Variable<D, FixedString{"x02"}> c;
  ddx::impl::Variable<D, FixedString{"x03"}> d;
  ddx::impl::Variable<D, FixedString{"x04"}> e;
  ddx::impl::Variable<D, FixedString{"x05"}> g;
  ddx::impl::Variable<D, FixedString{"x06"}> h;
  ddx::impl::Variable<D, FixedString{"x07"}> i;
...
static auto make_chain_expr16() {
  using D = ddx::impl::Dual<double>;
  using ddx::impl::FixedString;
  ddx::impl::Variable<D, FixedString{"x00"}> v00;
  ddx::impl::Variable<D, FixedString{"x01"}> v01;
  ddx::impl::Variable<D, FixedString{"x02"}> v02;
  ddx::impl::Variable<D, FixedString{"x03"}> v03;
  ddx::impl::Variable<D, FixedString{"x04"}> v04;
  ddx::impl::Variable<D, FixedString{"x05"}> v05;
  ddx::impl::Variable<D, FixedString{"x06"}> v06;
  ddx::impl::Variable<D, FixedString{"x07"}> v07;
  ddx::impl::Variable<D, FixedString{"x08"}> v08;
  ddx::impl::Variable<D, FixedString{"x09"}> v09;
  ddx::impl::Variable<D, FixedString{"x10"}> v10;
  ddx::impl::Variable<D, FixedString{"x11"}> v11;
  ddx::impl::Variable<D, FixedString{"x12"}> v12;
  ddx::impl::Variable<D, FixedString{"x13"}> v13;
  ddx::impl::Variable<D, FixedString{"x14"}> v14;
  ddx::impl::Variable<D, FixedString{"x15"}> v15;
...
static auto expr_energy(const Expr &E) {
  using Syms = ddx::impl::extract_symbols_from_expr_t<Expr>;
...
// Public router: handing the raw expression *graph* to ddx::impl::hessian() must
...
static void ours_hessian_expr(benchmark::State &state, MakeExpr make) {
  ...
  for (auto _ : state) {
    benchmark::DoNotOptimize(xs);
    auto H = ddx::impl::hessian(E, xs); // raw graph in, right driver out
    benchmark::DoNotOptimize(H);
    benchmark::ClobberMemory();
  }
}
...
[[maybe_unused]] const bool reverse_crosscheck_ran = [] {
  ...
  // Routed raw-callable Hessian: whichever driver ddx::impl::hessian() picks at each
  ...
  for (const std::size_t n : {std::size_t{8}, std::size_t{16}, std::size_t{17}}) {
    ...
    auto f = [n](const auto *dof) { return vf_energy_sparse(dof, n); };
    const auto [rv, rg, rh, rn] = ddx::impl::hessian(f, xs);
    const auto [sv, sg, sh, sn] = ddx::impl::detail::hessian(f, xs);
